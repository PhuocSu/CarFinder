      ...
      >
        ...
        >
          <Flex vertical gap={"40px"} align="center">
            <Flex vertical align="center" gap={"8px"} style={{width: "100%", padding: "20px", backgroundColor: "var(--primary-bg-color-primary-bg-5, #ECF0FE)"}}>
                <Typography.Text
                style={{color: 'var(--base-fg-color-base-fg-70, #313948)', fontSize: 18, fontFamily: 'Noto Sans KR', fontWeight: '400', wordWrap: 'break-word'}}
                >
                    회원님이 가입하신 아이디는 아래와 같습니다
                </Typography.Text>

                <Typography.Text
                style={{color: 'var(--primary-fg-color-primary-fg-90, #292B77)', fontSize: 28, fontFamily: 'Noto Sans KR', fontWeight: '700', wordWrap: 'break-word'}}
                >
                    ABC01031 
                </Typography.Text>
